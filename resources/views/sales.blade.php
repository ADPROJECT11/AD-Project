...
<body class="bg-gray-200">
    <div class="flex flex-row">
        ...
        <div class="flex flex-col w-full h-full">
            ...
            <main class="flex px-6 pt-24 pb-6" id="sales">
                <div class="flex flex-col px-6 py-6 bg-white shadow-md w-full rounded-xl">
                    ...
                    <div class="overflow-x-auto px-4">
                        <table class="w-full text-sm text-left text-gray-500">
                            <thead class="text-xs text-gray-700 uppercase rounded-t-xl bg-grey-300">
                                <tr>
                                    <th scope="col" class="px-4 py-3 rounded-tl-xl">Product name</th>
                                    <th scope="col" class="px-4 py-3">Category</th>
                                    <th scope="col" class="px-4 py-3">Quantity</th>
                                    <th scope="col" class="px-4 py-3 rounded-tr-xl">Value</th>
                                </tr>
                            </thead>
                            <tbody class="bg-grey-100">
                                <tr class="border-b border-grey-300">
                                    ...
                                    <td class="px-4 py-3">RM 2999</td>
                                </tr>
                                <tr class="border-b border-grey-300">
                                    <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">Apple iMac 20&#34;</th>
                                    <td class="px-4 py-3">PC</td>
                                    <td class="px-4 py-3">200</td>
                                    <td class="px-4 py-3">RM 1499</td>
                                </tr>
                                <tr class="border-b border-grey-300">
                                    <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">Apple iPhone 14</th>
                                    <td class="px-4 py-3">Phone</td>
                                    <td class="px-4 py-3">1237</td>
                                    <td class="px-4 py-3">RM 999</td>
                                </tr>
                                <tr class="border-b border-grey-300">
                                    <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">Apple iPad Air</th>
                                    <td class="px-4 py-3">Tablet</td>
                                    <td class="px-4 py-3">4578</td>
                                    <td class="px-4 py-3">RM 1199</td>
                                </tr>
                                <tr class="border-b border-grey-300">
                                    <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">Xbox Series S</th>
                                    <td class="px-4 py-3">Gaming/Console</td>
                                    <td class="px-4 py-3">56</td>
                                    <td class="px-4 py-3">RM 299</td>
                                </tr>
                                <tr class="border-b border-grey-300">
                                    <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">PlayStation 5</th>
                                    <td class="px-4 py-3">Gaming/Console</td>
                                    <td class="px-4 py-3">78</td>
                                    <td class="px-4 py-3">RM 799</td>
                                </tr>
                                <tr class="border-b border-grey-300">
                                    <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">Xbox Series X</th>
                                    <td class="px-4 py-3">Gaming/Console</td>
                                    <td class="px-4 py-3">200</td>
                                    <td class="px-4 py-3">RM 699</td>
                                </tr>
                                <tr class="border-b border-grey-300">
                                    <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">Apple Watch SE</th>
                                    <td class="px-4 py-3">Watch</td>
                                    <td class="px-4 py-3">657</td>
                                    <td class="px-4 py-3">RM 399</td>
                                </tr>
                                <tr class="border-b border-grey-300">
                                    <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">NIKON D850</th>
                                    <td class="px-4 py-3">Photo</td>
                                    <td class="px-4 py-3">465</td>
                                    <td class="px-4 py-3">RM 599</td>
                                </tr>
                                <tr class="border-b border-grey-300">
                                    <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">Monitor BenQ EX2710Q</th>
                    ...
                    <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4" aria-label="Table navigation">
                        <span class="text-sm font-noRM al text-gray-500">
                            Showing
