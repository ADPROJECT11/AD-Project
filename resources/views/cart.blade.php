    ...
    <div id="confirmation-modal" data-modal-backdrop="static" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative w-11/12 max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-grey-700">
                <button type="button" class="absolute top-3 right-2.5 text-grey-400 bg-transparent hover:bg-grey-200 hover:text-grey-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-grey-600 dark:hover:text-white" data-modal-hide="confirmation-modal">
                ...
                <div class="p-6 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-grey-500 dark:text-grey-400">Do you want to confirm your order?</h3>
                    ...
                    <button data-modal-hide="confirmation-modal" type="button" class="text-grey-500 bg-white hover:bg-grey-100 focus:ring-4 focus:outline-none focus:ring-grey-200 rounded-lg border border-grey-200 font-semibold px-5 py-2.5 hover:text-grey-900 focus:z-10 dark:bg-grey-700 dark:text-grey-300 dark:border-grey-500 dark:hover:text-white dark:hover:bg-grey-600 dark:focus:ring-grey-600">Cancel</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="relative w-11/12 max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-grey-700">
                <div class="p-6 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-grey-500 dark:text-grey-400">Order successfully confirmed</h3>
