...
<body class="bg-gray-200">
    <div class="flex flex-row">
        <div class="flex flex-row justify-start w-[25%]">
            ...
            <div class="flex flex-col w-[18%] ml-[2%] h-full fixed bg-white">
                ...
                <div class="flex flex-col text-black h-3/4">
                    <a class="flex flex-row w-full h-1/4 px-[15%] items-center font-bold text-xl" href="staffmenu"><img src="{{ asset('image/reservation.png')}}" width="35px" height="35px">Reservation</a>
                    ...
                    <a class="flex flex-row w-full h-1/4 px-[15%] items-center font-bold text-xl bg-gray-200" href="#"><img src="{{ asset('image/order.png')}}" width="35px" height="35px">Order List</a>
        ...
        <div class="flex flex-col w-full h-full">
            <header class="flex justify-center items-center bg-pigment-indigo-400 w-full h-[120px]">
            ...
            <main class="grid grid-cols-2 justify-between items-center my-12 px-12 gap-x-24 gap-y-12 w-full h-full">
                    ...
                    <div class="flex flex-col justify-center items-start mt-6 bg-white rounded-xl w-full">
                        <div class="px-4 pt-4">
                            <div class="mb-4">
                                ...
                                <p class="mx-2 italic text-gray-700">+ Extra noodles</p>
                            </div>
                            <div class="mb-4">
                                <h1 class="text-xl mx-2 font-bold">F01. Fish & Chips</h1>
                                <p class="mx-2 italic text-gray-700">+ No sauce</p>
